      ...
      <Box sx={{ borderRadius: '16px', overflow: 'hidden', border: `1px solid ${colors.border}`, background: colors.surface }}>
        {loading ? (
          ...
          <>
            ...
            <Box sx={{ display: 'grid', gridTemplateColumns: '140px 100px 110px 1fr 130px 130px 80px 1.2fr', gap: 1.5, px: 2.5, py: 1.5, background: colors.surfaceAlt, borderBottom: `1px solid ${colors.border}` }}>
